    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <View style={[styles.heroContainer, { height: width * 0.65 }]}>
        ...
        <TouchableOpacity
          style={[
            styles.backButton,
            { top: insets.top + 8, left: undefined, right: Spacing.containerPadding },
          ]}
      ...
      >
              ...
              >
                <Text
                  style={[
                    ...
                    book.status === status && styles.statusTabTextActive,
                  ]}
                >
                  {status === 'on_hold'
                    ? 'On Hold'
        ...
        <TouchableOpacity
          ...
          onPress={() => setIsPlaylistSheetOpen(true)}
          activeOpacity={0.85}
        >
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.placeholder}>
            No sessions yet — start reading to track your progress.
          </Text>
        </View>
          ...
          <View style={[styles.progressCard, Shadows.card]}>
            ...
            {myReview?.contains_spoilers && (
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 8 }}>
                ...
                <Text style={{ ...Typography.styles.labelSm, color: colors.onSurfaceVariant }}>
                  Contains spoilers
                </Text>
              </View>
            )}
    ...
    <View style={[styles.progressCard, Shadows.card]}>
      ...
      {review.contains_spoilers && !spoilerRevealed ? (
        ...
        >
          ...
          <Text
            style={{ ...Typography.styles.labelSm, color: colors.onSurfaceVariant, marginTop: 4 }}
          >
