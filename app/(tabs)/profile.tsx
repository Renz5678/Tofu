      ...
      >
            ...
            {isPending || isUploading ? (
              ...
              <Text
                style={[
                  ...
                  {
                    color: canSave ? colors.primary : colors.onSurfaceVariant,
        ...
        <ScrollView contentContainerStyle={modalStyles.body} keyboardShouldPersistTaps="handled">
          ...
          <View style={modalStyles.fieldGroup}>
            ...
            <View
              style={[
                modalStyles.usernameRow,
                { backgroundColor: colors.surfaceContainerLow, borderColor: usernameBorderColor },
              ]}
            >
      ...
      >
        ...
        <View style={styles.profileHeader}>
          ...
          >
            ...
            <Text style={[styles.editButtonText, { color: colors.onSurfaceVariant }]}>
              Edit Profile
            </Text>
          </TouchableOpacity>
          ...
          <View style={styles.quickStats}>
            ...
            <View style={styles.quickStatItem}>
              <Text
                style={[
                  ...
                  !isStreakActive && { color: colors.onSurfaceVariant, opacity: 0.6 },
                ]}
              >
            ...
            <View style={styles.quickStatItem}>
              <Text style={styles.quickStatValue}>
                {totalPagesRead > 1000 ? `${Math.round(totalPagesRead / 1000)}k` : totalPagesRead}
              </Text>
