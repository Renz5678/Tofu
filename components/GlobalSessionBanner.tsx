    ...
    >
      ...
      >
        <View style={styles.leftContent}>
          <Animated.View
            style={[styles.indicator, isPaused && styles.indicatorPaused, animatedIndicatorStyle]}
          />
          <View>
            <Text style={styles.title} numberOfLines={1}>
              {activeSession.bookTitle || 'Reading Session'}
            </Text>
            <Text style={styles.subtitle}>
              {isPaused ? 'Paused' : 'Active'} · Page {activeSession.startPage}
            </Text>
          </View>
        </View>
