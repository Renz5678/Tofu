    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <Animated.View
          ...
          style={[styles.ringCard, Shadows.card]}
        >
          <View style={styles.chartHeader}>
            ...
            <View
              style={[
                styles.streakBadge,
                !isStreakActive && { backgroundColor: colors.surfaceContainerHigh },
              ]}
            >
              <MaterialIcons
              ...
              />
              <Text
                style={[styles.streakText, !isStreakActive && { color: colors.onSurfaceVariant }]}
              >
              ...
              >
                <Text
                  style={[
                    ...
                    period === tab.value && styles.periodPillTextActive,
                  ]}
                >
                  {tab.label}
                </Text>
        ...
        <Animated.View
          ...
          style={[styles.sessionsCard, Shadows.card]}
        >
            ...
            recentSessions.map((s, i) => (
              <View key={s.id} style={[styles.sessionRow, i > 0 && styles.sessionRowBorder]}>
                ...
                <View style={styles.sessionStats}>
                  ...
                  <Text
                    style={[styles.sessionStat, { color: colors.onSurfaceVariant, opacity: 0.5 }]}
                  >
                    · {s.pages}p
                  </Text>
                </View>
